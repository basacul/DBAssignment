...
Die	[Code Dateien](https://github.com/basacul/DBAssignment/tree/master/archive)	sind	unserem	Auftritt	und	dem	git	beigefügt	und	können	dort eingesehen werden.
...
![Occurences of hashtags in the course of time](img/plot.png)
